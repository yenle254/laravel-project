                        ...
                        <form action="{{route('users.settings.update', $user->id)}}" method="POST" class="bill-detail">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <textarea class="form-control" name="adress" value="{{$user->address}}" placeholder="Address"></textarea>
                                </div>
                                <div class="form-group">
                                    <input class="form-control" name="town" value="{{$user->town}}" placeholder="Town / City" type="text">
                                </div>
                                <div class="form-group">
                                    <input class="form-control" name="state" value="state" placeholder="State / Country" type="text">
                                </div>
                                <div class="form-group">
                                    <input class="form-control" name="zip_code" value="zip_code" placeholder="Postcode / Zip" type="text">
                                </div>
                                <div class="form-group row">
                                    <div class="col">
                                ...
                                <div class="form-group text-right">
                                    <button type="submit" name="submit" class="btn btn-primary">UPDATE</a>
                                    <div class="clearfix">
                                </div>
                            </fieldset>
                        </form>
